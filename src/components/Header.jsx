  ...
  return (
    <div>
        ...
        <div className=' bg-white dark:bg-slate-800 flex justify-around w-full '>
            ...
            <div className='toogle sm:flex transform translate-x-7  pt-5 right-0 w-10 h-screen bg-green-600   absolute z-20  md:hidden'>
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-10 -translate-x-1 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
